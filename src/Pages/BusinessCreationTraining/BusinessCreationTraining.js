        ...
        <section className='Bct'>
            ...
            <article className="Bct-article">
                ...
                <ol>
                    ...
                    <br></br>
                    <p>Sans engagement marque la première étape. C'est l'occasion de faire connaissance avec le consultant formateur, de poser des questions sur l’accompagnement et d'exposer le projet.
                    </p>
                    <br></br>
                    <p>Le consultant :</p>
                    <p>Fera préciser l'objectif de la demande et les circonstances du projet afin d'analyser les besoins pour co construire la formation avec vous.</p>
                    <p>Il vous Informera de la méthodologie, puis présentera le cabinet, les intervenants, le prix.</p>
                    <br></br>
                    <p>La formation se déroule en général entre 8 à 12 entretiens d’1 heure 30.</p>
                    <p>Les rendez-vous sont réalisés sous format d'entretiens en face à face.</p>
                    <p>Qu'il s'agisse de présentiel ou de distantiel, ces entretiens sont individuels et personnalisés.</p>
                    <p>Créer une entreprise est une démarche logique et itérative. Votre projet de création va vous amener à suivre des étapes et revenir sans cesse en arrière pour ajuster votre projet aux réalités du marché.</p>
                    <br></br>
                    <li className="Bct-article-subtitle">LE PROJET</li>
                    <br></br>
                    <p>L'objectif de cette étape est de prendre le temps de bien réfléchir à son projet personnel en amont, de faire le point sur ses compétences, de se fixer un cap, des objectifs personnels, d’identifier les différentes contraintes qui pèsent sur le projet, de quantifier les moyens à mettre en oeuvre pour se lancer et d’anticiper d’éventuelles difficultés.</p>
                    <br></br>
                    <p>Il s'agit de :</p>
                    <ul>
                    ...
                    <br></br>
                    <p>L'objectif de cette étape est de définir une stratégie d'entreprise et de maitriser les outils d'études de marché afin d'élaborer un plan d'actions.</p>
                    <br></br>
                    <p>Il s'agit de :</p>
                    <ul>
                    ...
                    <br></br>
                    <p>L'objectif de cette étape est d'être capable de définir l'ensemble des moyens nécessaires au bon fonctionnement de l'entreprise et de les chiffrer.
                    </p>
                    <br></br>
                    <p>Il s'agit de :</p>
                    <ul>
                    ...
                    <br></br>
                    <p>L'objectif de cette étape est de connaitre et manipuler les outils de financement du projet.</p>
                    <br></br>
                    <p>Il s'agit de :</p>
                    <ul>
                    ...
                    <br></br>
                    <p>L'objectif de cette étape est de préparer ses tableaux de bords de suivi financiers.</p>
                    <br></br>
                    <p>Il s'agit de :</p>
                    <ul>
                    ...
                    <br></br>
                    <p>L'objectif de cette étape est de bien connaitre les différents statuts afin de choisir celui le mieux adapté, celui qui possède le plus d'avantages et présente le minimum de risques pour vous.</p>
                    <br></br>
                    <p>Il s'agit de :</p>
                    <ul>
                    ...
                    <br></br>
                    <p>L'objectif de cette étape est de fixer un plan d'actions des formalités à entreprendre selon votre entreprise, son statut et ses spécificités.</p>
                    <br></br>
                    <p>Il s'agit de :</p>
                    <ul>
                    ...
                    <br></br>
                    <p>Il s'agit d'un rdv 6 mois après le dernier entretien, afin d'évaluer l'avancement du projet et d'apporter des conseils et informations selon les besoins exprimés.</p>
                    <br></br>
                </ol>
