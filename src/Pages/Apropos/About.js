...
const About = () => {
    return (
        <section className='About'>
            ...
            <div className='Pres-centeredText'>
            ...
            <div className='Certif'>
                <div className='PresQualiopi'>
                    <span>
                        ATTRIBUT CONSEILS est titulaire du processus qualité́ <span className='QualName'>QUALIOPI</span>, certificat de qualification professionnelle, qui atteste de la qualité du processus mis en œuvre par les prestataires d’actions concourant au développement des compétences, qu’il s’agisse d’actions de formation, de bilans de compétences :
                    </span>
                    <ul>
                    ...
                    <div className='QualiopiContainer'>
                        <p className='Qualiopi-validity'>Validé jusqu'au 31/12/ 2024.</p>
                        <img className='QualiopiPresPic' src={Qualiopi} alt='Logo Qualiopi' />
                    </div>
                    <div className='QualiopiScope'>
                ...
                <div className='DataDocContainer'>
