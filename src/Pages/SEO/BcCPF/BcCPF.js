...
import Cpf from '@/Assets/Images/CPF_White.png'
    ...
    return (
        <section className='SeoCPF'>
            ...
            <article className="timeline firstRight-container right-container withMovie">
                <div className="litleWhiteDot"></div>
            ...
            <article className="timeline right-container articleCertif"> */}
                ...
                <div className="DownYellowDot"></div>
            </article>
            ...
            <article className="timeline right-container withoutTitle">
