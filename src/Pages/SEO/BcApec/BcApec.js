...
const BcApec = () => {
    ...
    const mainTitleFaq = 'Experts et outils adaptés à chaque projet professionnel'
    const mainPfaq = 'Notre équipe d\'experts et de formateurs qualifiés et certifiés met à votre disposition les outils adaptés pour réaliser votre bilan de compétences et vous accompagner dans votre projet professionnel. '
    return (
        <section className='Seo'>
            <MetaTitleDes title={metaTitle} description={metaDescription} />

            <h1><span>Réaliser son</span><br /> BILAN DE COMPÉTENCES AVEC L'APEC </h1>
            <p className='Seo_Yellow'>Vous souhaitez réaliser un bilan de compétences avec l’APEC mais vous ne savez pas quelles sont les démarches à effectuer ? Laissez-nous vous guider !</p>
