...
const Fontainebleau = () => {
    ...
    return (
        <section className='SeoBleau'>
            <MetaTitleDes title={metaTitle} description={metaDescription} />

            <h1><span>Votre</span><br /> BILAN DE COMPÉTENCES A <span className='Title city'>{ville}</span></h1>
            <p className='SeoBleau_Yellow'>Vous cherchez à réaliser un bilan de compétences à {ville} ? Contactez notre cabinet spécialisé en Seine-et-Marne, retour rapide assuré !</p>
            <div className="SeoBleau container-img">
                <img className='Tree' src={LogoTree} alt="Logo arbre Attribut conseils" />
            </div>
            <article className="SeoBleau-article">
            ...
            <article className="timeline right-container articleCertif lastP">
            ...
            <article className="timeline left-container firstP">
            ...
            <article className="timeline left-container withMovie lastP ">
            ...
            <article className="timeline right-container lastP">
